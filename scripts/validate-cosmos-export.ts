...
const expectedFixtureFiles = [
  ...
  "pages/simplified-am62l-ddr-ram-repro.page.tsx",
  "pages/simplified-am62l-ddr-soc-repro-fixed-layer-distribution.page.tsx",
  "pages/simplified-am62l-ddr-soc-repro.page.tsx",
...
if (JSON.stringify(fixtureFiles) !== JSON.stringify(expectedFixtureFiles)) {
  throw new Error(
    `Expected exactly ${expectedFixtureFiles.length} approved BGA fixture pages, found ${fixtureFiles.length}: ${fixtureFiles.join(", ")}`,
  )
}
